...
Cualquiera que haya estudiado programación sabe que por un lado tenemos que interiorizar una serie de conceptos como algoritmo, bucle, etc y por otro lado necesitamos una serie de habilidades informáticas para trabajar con el ordenador, como saber encontrar un fichero, cómo capturar una imagen, etc. 
...
* No necesitamos un equipamiento complejo ya que la mayoría de estos juegos están pensados para hacerlo con unas cartas y un tablero que imprimimos.
...
La mecánica del juego es muy sencilla: repartimos unas cartas impresas previamente y en cada mano vamos eligiendo los movimientos que queremos hacer según el objetivo que tengamos. También podemos definir unas rreglas propias.
...
Como ejemplo del primer tipo podría ser:  ¿qué es la informática para nosotros?, no es simplemente el ordenador, es mucho más. Otro ejemplo: cuando buscamos en una página como Google, ¿estoy haciendo uso de una cosa muy sencilla como parece, una caja donde escribimos un texto y ya está? ¿Qué hay detrás?. 
...
* Está pensado para intentar eliminar el estereotipo. 
* Trabajar la cohesión del equipo trabajando de una forma cooperativa.
* Trabajar muy bien los roles, para evitar la reticencia que tiene a veces las alumnas a trabajar estos temas.
